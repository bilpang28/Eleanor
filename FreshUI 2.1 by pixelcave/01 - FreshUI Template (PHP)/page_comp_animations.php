    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2 text-center">
            ...
            <p class="animation-buttons">
                <a href="javascript:void(0)" class="btn btn-sm btn-primary" data-animation="animation-fadeInQuick">FadeInQuick - New</a>
                <a href="javascript:void(0)" class="btn btn-sm btn-primary" data-animation="animation-fadeInQuickInv">FadeInQuickInv - New</a>
                <a href="javascript:void(0)" class="btn btn-sm btn-primary" data-animation="animation-fadeInLeft">FadeInLeft - New</a>
                <a href="javascript:void(0)" class="btn btn-sm btn-primary" data-animation="animation-fadeInRight">FadeInRight - New</a>
                <a href="javascript:void(0)" class="btn btn-sm btn-primary" data-animation="animation-fadeIn360">FadeIn360 - New</a>
