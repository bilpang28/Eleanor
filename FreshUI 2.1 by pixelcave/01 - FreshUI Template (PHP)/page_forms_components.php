    ...
    <div class="block">
        ...
        <form action="page_forms_components.php" method="post" class="form-horizontal" onsubmit="return false;">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <select id="example-select2" name="example-select2" class="select-select2" data-placeholder="Choose one.." style="width: 250px;">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <select id="example-select2-multiple" name="example-select2-multiple" class="select-select2" data-placeholder="Choose one.." style="width: 250px;" multiple>
                        <option></option><!-- Required for data-placeholder attribute to work with Select2 plugin -->
                        <option value="HTML">HTML</option>
                        <option value="CSS">CSS</option>
                        <option value="Javascript">Javascript</option>
